...
import com.ning.matomochatgpt.entity.res.VisitFrequencyResponse;
import lombok.Data;

/**
 * ClassName: VisitFrequencyMethod <br/>
 *
 * @author Ning <br/>
 * @date 2023/10/19 0019
 * @since JDK 11
 */
public class VisitFrequencyMethod extends MatomoApi {

    public VisitFrequencyMethod(ConfigClient configClient, MatomoRequestParam matomoRequestParam) {
    ...
    public MatomoResponse api() throws JsonProcessingException {
        ...
        return JSON.parseObject(jsonData, VisitFrequencyResponse.class);
    }
}
